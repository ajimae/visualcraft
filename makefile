...
help: ## Show this help message
	@echo "$(BLUE)Visualcraft - Available Commands$(NC)"
	@echo ""
...
cli-test: build ## Test CLI with sample HTML
	...
	node dist/bin/visualcraft.js -i test-cli.html -o test-cli-output.pdf
	@echo "$(GREEN)✅ PDF generated: test-cli-output.pdf$(NC)"
